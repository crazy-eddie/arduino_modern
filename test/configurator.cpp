...
BOOST_AUTO_TEST_CASE(set_mode)
{
    ...
    static_assert(is_same(test_configurator, configurator_<int, pin_config_<test_desc<pin1_tag>, unset_mode>, pin_config_<test_desc<pin2_tag>, unset_mode> >{}), "");

    static_assert(is_same(test0, configurator_<int,  pin_config_<test_desc<pin1_tag>, input_tag>, pin_config_<test_desc<pin2_tag>, unset_mode> >{}), "");
    ...
    static_assert(is_same(test2, configurator_<int, pin_config_<test_desc<pin1_tag>, input_tag>, pin_config_<test_desc<pin2_tag>, output_tag> >{}), "");
